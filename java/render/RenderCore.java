...
public class RenderCore implements Runnable {
   ...
   synchronized void recalculateSize(int currentWidth, int currentHeight) {
      ...
      if (renderer == null) //TODO when applet mode, crashes when setSize is called too early
         return;
   ...
   /**
    * Sets the x coordinate of view center of projection.
    * <p>
    * 
    * @param value
    * @see Renderer#setCx(double value)
    */
   public void setCx(double value) {
      renderer.setCx(value);
   }

   /**
    * Sets the y coordinate of view center of projection.
    * <p>
    * 
    * @param value
    * @see Renderer#setCy(double value)
    */
   public void setCy(double value) {
      renderer.setCy(value);
   }
   ...
   /**
    * gets the x coordinate of the center of projection.
    * <p>
    * 
    * @see Renderer#setCx(double value)
    */
   public double getCx() {
      return renderer.getCx();
   }

   /**
    * gets the y coordinate of the center of projection.
    * <p>
    * 
    * @see Renderer#setCy(double value)
    */
   public double getCy() {
      return renderer.getCy();
   }
    ...
    Thread currentThread = Thread.currentThread();
      while (currentThread == t) {
         ...
         if (isDamage) {
            ...
            // RESIZE THE RENDERER WHENEVER NECESSARY

            int w = renderablePanel.getWidth();
            int h = renderablePanel.getHeight();
            if (w != W || h != H)
               recalculateSize(w, h);
