function [ im_filtered ] = filter_zero_bndry_with_scale( im, kernel1d, scales )
% Scales is generated by convolving an image of all ones with the kernel1d
% (in both dimensions), and assuming all zeros outside of the image
...
for v = 1:h
  for u = 1:w
    im_filtered(v, u) = im_filtered(v, u) / scales(v, u);
  end
end
