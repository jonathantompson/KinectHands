...
set_file:writeString(string.format('%dx%d L%d, ', poolsize[1], poolsize[1], lpooling[1]))
...
set_file:writeString('spac sub., ')
set_file:writeString(string.format('%dx%d L%d, ', poolsize[2], poolsize[2], lpooling[2]))
