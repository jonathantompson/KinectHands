...
//
//  FOR A CLEANED-UP VERSION OF THE CODE, SEE HAND-FIT-> HAND-POSE PROJECT
//
//  Takes as input a vertex and index array (and optional per-vertex color).  
//  It will modify the vertex, index and color array (as a simplified mesh) and 
//  it will calculate and return the per vertex normals.
//
