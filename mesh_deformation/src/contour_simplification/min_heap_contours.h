...
#ifndef CONTOUR_SIMPLIFICATION_MIN_HEAP_CONTOURS_HEADER
#define CONTOUR_SIMPLIFICATION_MIN_HEAP_CONTOURS_HEADER
...
#endif  // CONTOUR_SIMPLIFICATION_MIN_HEAP_CONTOURS_HEADER
