...
#include <cmath>
#include <sstream>
#include "kinect_interface_primesense/hand_net/hand_net.h"
...
#include "kinect_interface_primesense/hand_net/hand_model.h"  // for HandModel
#include "kinect_interface_primesense/open_ni_funcs.h"
#include "kinect_interface_primesense/hand_detector/decision_tree_structs.h"  // GDT_MAX_DIST
...
using kinect_interface_primesense::hand_net::HandCoeff;
...
#define LINEAR_PENALTY
  ...
  float HandNet::calcPenalty(const float* coeff) {
    ...
    const float* penalty_scale = kinect_interface_primesense::hand_net::HandModel::coeff_penalty_scale();
    const float* max_limit = kinect_interface_primesense::hand_net::HandModel::coeff_max_limit_conservative();
    const float* min_limit = kinect_interface_primesense::hand_net::HandModel::coeff_min_limit_conservative();
  ...
  double HandNet::calcPenalty(const double* coeff) {
    ...
    const float* penalty_scale = kinect_interface_primesense::hand_net::HandModel::coeff_penalty_scale();
    const float* max_limit = kinect_interface_primesense::hand_net::HandModel::coeff_max_limit_conservative();
    const float* min_limit = kinect_interface_primesense::hand_net::HandModel::coeff_min_limit();;
  ...
  void HandNet::setPSORadius() {
    const float* cmax = kinect_interface_primesense::hand_net::HandModel::coeff_max_limit();
    const float* cmin = kinect_interface_primesense::hand_net::HandModel::coeff_min_limit();
