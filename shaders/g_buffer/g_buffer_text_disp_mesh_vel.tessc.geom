...
// Velocity blur only:
in vec4 f_gl_position_cs_in[];
in vec4 f_gl_position_prev_cs_in[];
...
// Velocity blur only:
out vec4 f_gl_position_es_in[];
out vec4 f_gl_position_prev_es_in[];
...
void main() {
  ...
  f_gl_position_es_in[gl_InvocationID] = f_gl_position_cs_in[gl_InvocationID];
  f_gl_position_prev_es_in[gl_InvocationID] = f_gl_position_prev_cs_in[gl_InvocationID];
