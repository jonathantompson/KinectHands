...
kinect_data = loadImageFile('kinect_depth_texture.bin', im_width * tile_x, im_height * tile_y, 1, 'float');
% figure; imshow(kinect_data); title('Kinect Depth');

rendered_depth = loadImageFile('depth_texture.bin', im_width * tile_x, im_height * tile_y, 1, 'float');
...
[residue_texture_1, delta_d_1, union_1, intersect_1] = loadImageFile('residue_texture_1.bin', im_width * tile_x, im_height * tile_y, 3, 'float');
...
%% First Downsample
[residue_texture_2, delta_d_2, union_2, intersect_2] = loadImageFile('residue_texture_4.bin', im_width * tile_x / 4, im_height * tile_y / 4, 3, 'float');
...
%% Second Downsample
[residue_texture_3, delta_d_3, union_3, intersect_3] = loadImageFile('residue_texture_16.bin', im_width * tile_x / 16, im_height * tile_y / 16, 3, 'float');
...
%% Third Downsample
[residue_texture_4, delta_d_4, union_4, intersect_4] = loadImageFile('residue_texture_32.bin', im_width * tile_x / 32, im_height * tile_y / 32, 3, 'float');
...
%% Fourth Downsample
[residue_texture_5, delta_d_5, union_5, intersect_5] = loadImageFile('residue_texture_160.bin', im_width * tile_x / 160, im_height * tile_y / 160, 3, 'float');
