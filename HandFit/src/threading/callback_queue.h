...
#ifndef THREADING_CALLBACK_QUEUE_HEADER
#define THREADING_CALLBACK_QUEUE_HEADER
...
namespace threading {
  ...
  template <typename T>
  void CallbackQueue<T>::enqueue(T newItem) {
...
#endif  // THREADING_CALLBACK_QUEUE_HEADER
