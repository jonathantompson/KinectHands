...
int main(int argc, char *argv[]) { 
  ...
  SDBFitting* solver = new SDBFitting(NUM_COEFFS_HW7_4A);
  ...
  SDBFitting* solver2 = new SDBFitting(NUM_COEFFS_HW7_4B);
  solver2->max_iterations = 1000;
  solver2->delta_f_term = 1e-20f;
  solver2->jac_2norm_term = 1e-20f;
  solver2->delta_x_2norm_term = 1e-20f;
