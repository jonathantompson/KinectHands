...
#ifndef UNNAMED_WIN32_DEBUG_BUFFER_HEADER
#define UNNAMED_WIN32_DEBUG_BUFFER_HEADER
...
class BufferedStringBuf : public std::streambuf {
 public:
  explicit BufferedStringBuf(int bufferSize) {
    if (bufferSize) {
...
#endif  // UNNAMED_WIN32_DEBUG_BUFFER_HEADER
