...
namespace math {
  ...
  // Misc. math functions
  void calcOpenGLAffine(float* ret, Vec3<float>* axes, Vec3<float>* trans);
  void calcOpenGLAffine(float* ret, Vec3<float>* axes, float* trans);
...
#define MAX_VAL(a, b) ((a)>(b)?(a):(b))
  ...
  template <class T>
  void PolarDecomposition(Mat4x4<T>* M, Mat4x4<T>* Q, Mat4x4<T>* S) {
